...
#     # output: Please stand by. Computer is rebooting.
...
# else:
#     print("Stable speed")
# Output should be "stable speed"


# # 4) PREDICT: Do the code blocks shown in the Section D produce the same result?
# if crew_status and computer_status_code == 200 and space_suits_on: #these are all true
#    print("all systems go") #this will print
# else: 
#    print("WARNING. Not ready")

# if crew_status != True or computer_status_code != 200 or not(space_suits_on): #these are all false
#    print("WARNING. Not ready")
# else:
#    print("all systems go") #this will print
